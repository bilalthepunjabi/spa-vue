...
export default defineComponent({
  ...
  mounted(){
    store.main.api().authin({}).then(res => {
      console.log(res);
    });
  },
  methods: { 
    sun(){
      store.main.app().switch();
      this.theme = 'sun'
    },
    moon(){
      store.main.app().switch();
              ...
              <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                ...
                <div class="lg:py-24">
                  ...
                  <p class="mt-3 text-base dark:text-gray-300 text-gray-800 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    This branch [tailwind] of <a href="https://github.com/bilalthepunjabi/vue-template">https://github.com/bilalthepunjabi/spa-vue.git</a> includes built-in { @tailwindcss / @headless-ui }.
                  </p>
                </div>
              </div>
